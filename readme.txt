...
In additon to the features of the free plugin, there is an advanced version available from cubecolour called [Correct Horse Battery Staple Plus](http://cubecolour.co.uk/downloads/correct-horse-battery-staple-plus/ "http://cubecolour.co.uk/downloads/correct-horse-battery-staple-plus/") which adds the following capabilities and features:

<ul>
	<li>Use for self-registered users (single site and multisite)</li>

	<li>Use for Password resets</li>

	<li>Choice of different number of words in the password</li>

	<li>Append a numerical suffix to the password</li>

	<li>Option for one of the password words to be all uppercase</li>
</ul>
...
This version is designed for use on the *Add New user* (user-new.php) and *Your Profile* (profile.php) admin pages. [Correct Horse Battery Staple Plus](http://cubecolour.co.uk/downloads/correct-horse-battery-staple-plus/ "Correct Horse Battery Staple Plus") enables the XKCD-style passwords to also be generated for users registering themselves.
...
= 1.1.0 =
* Limit the filter to profile.php & user-new.php admin pages to prevent self-registration breaking.
